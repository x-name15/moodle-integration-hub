...
/**
 * Gateway — main HTTP client for Integration Hub.
 *
 ...
 *   $response = $gateway->request('judgeman', '/execute', ['code' => $code]);
 *
...
class gateway
{
    ...
    /**
     * Make an HTTP or AMQP request to a registered service.
     *
        ...
        string $method = ''): gateway_response
    {
        ...
        return new gateway_response($success, $httpstatus, $responsebody, $error, $latencyms, $attempts);
    }
